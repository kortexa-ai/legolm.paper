...
def main() -> None:
    ...
    print(f"Wrote {tex}")
    copy_summary(args.lfm, args.output_dir, "summary-lfm.json")
    copy_summary(args.lfm_scaling, args.output_dir, "summary-lfm-scaling.json")
    if args.compile:
