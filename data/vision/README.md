...
was trained on these frame-caption pairs in the development tree with a joint
perceiver+LM caption objective over 50 epochs; the paper runner uses only the
frozen perceiver weights.
